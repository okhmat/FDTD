...
if __name__=="__main__":
    ...
    def time_step_periodic(n):
        Hx[0:Nz-1] += mHx[0:Nz-1] * (Ey[1:Nz] - Ey[0:Nz-1]) / dz - mHx[0:Nz-1] * Mx[n]
        Hx[Nz-1] += mHx[Nz-1] * (Ey[0] - Ey[Nz-1]) / dz - mHx[Nz-1] * Mx[n]

        Ey[1:Nz] += mEy[1:Nz] * (Hx[1:Nz] - Hx[0:Nz - 1]) / dz
        Ey[0] += mEy[0] * (Hx[0] - Hx[Nz-1]) / dz
    ...
    f = r"./1D_EyHx_mode_Period_BC.mp4"
